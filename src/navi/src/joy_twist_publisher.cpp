...
private:
	...
	int joy_controll_button = 8; // このボタンを押すとジョイコンで動く。押さないとmove_baseで動く
	// /* 十字ボタンで直進と回転
...
public:
	TwistPublisher() : nh_(), pnh_("~")
	{
		...
		pnh_.getParamCached("/joy/joy_controll_button", joy_controll_button);
	...
	void timerCallback(const ros::TimerEvent &e)
	{
		...
		/* joy_controll_buttonが押されているときだけcmd_velをpublish */
		if (last_joy_.buttons[joy_controll_button] == 1)
		{
			/* joyの入力からcmd_velを計算 */
			// /* 十字ボタンで直進と回転
